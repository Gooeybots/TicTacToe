...
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug -o Makefile TicTacToe.pro
#############################################################################
...
Makefile: TicTacToe.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug -o Makefile TicTacToe.pro
...
winscreen.o: winscreen.cpp gameenums.hpp \
		...
		mousekeyboard.hpp \
		draw.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o winscreen.o winscreen.cpp

draw.o: draw.cpp board.hpp \
		draw.hpp \
		gameenums.hpp
